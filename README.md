# genpark-payload-filtered-hnsw-vector-similarity-engine-skill
...
> **GenPark AI Agent Skill** -- Payload filtered HNSW vector similarity engine with quantization (Qdrant style)
